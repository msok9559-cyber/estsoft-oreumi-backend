...
public class ExchangeServlet3 extends HttpServlet {
    ...
    private static final double CHINA_RATE = 0.00475;

    // 환율 정보를 저장함 HashMap 인스턴스
    private final Map<String, Double> exchangeRates = new HashMap<>();

    public ExchangeServlet3() {
        super();
        System.out.println("CALL: ExchangeServlet3#ExchangeServlet3()");
    }
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        exchangeRates.put("cny", CHINA_RATE);
    }
